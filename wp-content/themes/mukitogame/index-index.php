		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-xs-4 text-center x-btn-1">
					<div class="_">
						<a href="play.html?player=1&t=m"><img class="img-responsive" src="<?php echo get_template_directory_uri() ?>/public/image/player1.png"></a>
                    </div>
					<div class="_">
				...
				<div class="col-md-4 col-xs-4 text-center x-btn-1">
					<div class="_">
						<a href="play.html?player=2&t=m"><img class="img-responsive" src="<?php echo get_template_directory_uri() ?>/public/image/player2.png"></a>
					</div>
					<div class="_">
				...
				<div class="col-md-4 col-xs-4 text-center x-btn-1">
					<div class="_">
						<a href="play.html?player=3&t=m"><img class="img-responsive" src="<?php echo get_template_directory_uri() ?>/public/image/player3.png"></a>
					</div>
					<div class="_">
