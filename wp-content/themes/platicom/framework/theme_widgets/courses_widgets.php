...
class MY_Course_Widget extends WP_Widget {
	...
	function MY_Course_Widget() {
		...
		$this->WP_Widget(false,IAMD_THEME_NAME.__(' Course','dt_themes'),$widget_options);
	}
	...
	function form($instance) {
        ...
        <!-- Form -->
        <p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Titulo:','dt_themes');?> 
	    ...
	    <p><label for="<?php echo $this->get_field_id('_post_categories'); ?>">
			<?php _e('Elija las categor&iacute;as que desee mostrar (selecci&oacute;n m&uacute;ltiple posible)','dt_themes');?></label>
            <select class="widefat" id="<?php echo $this->get_field_id('_post_categories').'[]';?>" 
                ...
                <option value=""><?php _e("Seleccionar",'dt_themes');?></option>
        ...
        <p><input type="checkbox"  id="<?php echo $this->get_field_id('_enable_course_image');?>" name="<?php echo $this->get_field_name('_enable_course_image');?>"
	         <?php checked($_enable_course_image); ?> /> <?php _e("Mostrar imagen",'dt_themes');?></p>  

	    <p><label for="<?php echo $this->get_field_id('_post_count'); ?>"><?php _e('No. de publicaciones a mostrar:','dt_themes');?></label>
