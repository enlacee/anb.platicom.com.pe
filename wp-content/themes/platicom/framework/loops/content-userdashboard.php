			...
			?>
               ...
               <div>
                <div class="dt-sc-hr-invisible-small"></div>
                    ...
                    <h4 class="border-title"> <?php echo __('Perfil', 'dt_themes'); ?> <span> </span> </h4>
                    <ul class="teachers-details">
                        <li><strong><?php echo __('Usuario : ', 'dt_themes'); ?></strong><?php echo $user_info->user_login; ?></li>
                        <li><strong><?php echo __('Nombres : ', 'dt_themes'); ?></strong><?php echo $user_info->first_name; ?></li>
                        <li><strong><?php echo __('Apellidos : ', 'dt_themes'); ?></strong><?php echo $user_info->last_name; ?></li>
                        <li><strong><?php echo __('Nombre a mostrar : ', 'dt_themes'); ?></strong><?php echo $user_info->display_name; ?></li>
                        <li><strong><?php echo __('Email : ', 'dt_themes'); ?></strong><?php echo '<a href="mailto:'.$user_info->user_email.'">'.$user_info->user_email.'</a>'; ?></li>
                    </ul>
